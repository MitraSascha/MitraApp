...
export const TOPICS: Record<string, TopicConfig> = {
  sanitaer: {
    ...
    hersteller: [
      'Grohe', 'Hansgrohe', 'Geberit', 'Kaldewei', 'Villeroy & Boch',
      'Duravit', 'Ideal Standard', 'Roca', 'Hansa', 'TECE',
      'Dornbracht', 'Kludi', 'Viega', 'Keuco',
    ],
  },
  heizung: {
    ...
    hersteller: [
      'Viessmann', 'Buderus', 'Vaillant', 'Wolf', 'Weishaupt',
      'Junkers', 'Grundfos', 'Wilo', 'Stiebel Eltron', 'Ochsner',
      'ROTEX', 'Vallox', 'Zehnder',
    ],
  },
  notdienst: {
